...
type SingleAction struct {
	...
	Params []byte `protobuf:"bytes,2,opt,name=params,proto3" json:"params,omitempty"` // 请求参数列表
}
...
func (x *RespExec) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
var file_proxy_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x52, 0x06, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x4c, 0x0a, 0x08, 0x52, 0x65,
	...
	0x28, 0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x38, 0x0a, 0x0e, 0x44, 0x42, 0x50, 0x72,
	0x6f, 0x78, 0x79, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x26, 0x0a, 0x0d, 0x45, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x65, 0x41, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x08, 0x2e, 0x52, 0x65,
	0x71, 0x45, 0x78, 0x65, 0x63, 0x1a, 0x09, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x45, 0x78, 0x65, 0x63,
